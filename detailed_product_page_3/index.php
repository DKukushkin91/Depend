...
<!--            <div class="banner-text__subtitle"><span>Продукция&emsp;>&emsp;</span><span>Впитывающее нижнее белье Depend® для Мужчин L/XL</span></div>-->
        </div>
    </section>
    <section class="main-prod-card">
        <h2>Впитывающее нижнее белье Depend® для Мужчин L/XL</h2>
        <div class="flex-product-card">
            <div class="product-photo">
                <div class="photo-selector for-men">
                    <div class="selector-button current-photo"><img src="<?=SITE_TEMPLATE_PATH?>/img/underpants-for-men-2D.jpg" alt=""></div>
                    <div class="selector-button"><img src="<?=SITE_TEMPLATE_PATH?>/img/underpants-for-men-2D.jpg" alt=""></div>
                    <div class="selector-button"><img src="<?=SITE_TEMPLATE_PATH?>/img/underpants-for-men-2D.jpg" alt=""></div>
                    <div class="selector-button"><img src="<?=SITE_TEMPLATE_PATH?>/img/underpants-for-men-2D.jpg" alt=""></div>
                </div>
                <div class="big-photo">
                    <img src="<?=SITE_TEMPLATE_PATH?>/img/underpants-for-men-2D.jpg" alt="">
                </div>
                <script>
            ...
            <div class="product-description">
                <div>
                    <div class="incontinence-rate">
                        <div class="droplets"><span class="drop green"></span><span class="drop green"></span><span class="drop green"></span><span class="drop green"></span><span class="drop green"></span><span class="drop green"></span><span class="drop green"></span></div>
                        <span>Максимальная впитываемость</span>
                    </div>
                    <div class="size-block">
                        <div class="size-info">
                            <span>Размер:</span><div class="size-value">L/XL — 48/54</div>
                        </div>
                        <div class="size-info">
                            <span>Объем бедер:</span><div class="size-value">84-110 см</div>
                        </div>
                    </div>
                </div>
                <div>
                    <h3>О продукте</h3>
                    <p>Наше впитывающее белье Depend® создано специально для мужчин с учетом <i>анатомических особенностей</i> тела. Оно способно не только защитить Вас в течение всего дня, но и подарить комфорт в ношении как у нижнего белья.</p>
                </div>
        ...
        <div class="full-characteristics">
            ...
            <div class="all-properties txt-center">
                <div class="basic-property pants-property">
                    <img src="<?=SITE_TEMPLATE_PATH?>/img/stretch-men.png" alt="">
                    <span class="name-prop">Мягкое и удобное<br>стретч-облегание</span>
                </div>
                <div class="basic-property pants-property">
                    <img src="<?=SITE_TEMPLATE_PATH?>/img/low-waist-men.png" alt="">
                    <span class="name-prop">С низкой талией,<br>незаметно под одеждой</span>
                </div>
                <div class="basic-property pants-property">
                    <img src="<?=SITE_TEMPLATE_PATH?>/img/5-times-more-men.png" alt="">
            ...
            <div class="size-block">
                ...
                <div class="size-info">
                    <span>Впитываемость:</span><div class="droplets"><span class="drop green"></span><span class="drop green"></span><span class="drop green"></span><span class="drop green"></span><span class="drop green"></span><span class="drop green"></span><span class="drop green"></span></div>
                </div>
            </div>
